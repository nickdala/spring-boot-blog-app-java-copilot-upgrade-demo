# Blogging platform (made with Spring Boot) used a demo for the [GitHub Copilot upgrade assistant for Java](https://devblogs.microsoft.com/java/technical-preview-github-copilot-upgrade-assistant-for-java/)
